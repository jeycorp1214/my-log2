...
export function ListEventItem({
  ...
  return (
    <View className="flex-row items-center border-b border-[#1e1e1e]">
      <View
        className="w-1 self-stretch"
        style={{ backgroundColor: groupColor ?? "#2a2a2a" }}
      />
      <View className="flex-1 flex-row items-center gap-3 py-3 px-4">
        {isRepeat ? (
